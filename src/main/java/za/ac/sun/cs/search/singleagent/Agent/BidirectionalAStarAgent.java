...
public class BidirectionalAStarAgent implements Agent {
    ...
    public BidirectionalAStarAgent(short[] configuration, boolean allowUnoptimalSolution, Heuristic heuristic) {
        ...
        short[] initialStateBackward = Arrays.copyOf(this.startBoardForward.getGoalState(),
                this.startBoardForward.getGoalState().length);
    ...
    /**
     * Solve the given N-puzzle using Bidrectional A* on an explicit tree.
     *
